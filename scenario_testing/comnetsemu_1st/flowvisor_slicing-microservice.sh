...
fvctl -f /etc/flowvisor/flowvisor.passwd add-slice -p 123 upper tcp:10.0.0.241:30001 admin@upperslice
fvctl -f /etc/flowvisor/flowvisor.passwd add-slice -p 123 middle tcp:10.0.0.241:30002 admin@middleslice
fvctl -f /etc/flowvisor/flowvisor.passwd add-slice -p 123 lower tcp:10.0.0.241:30003 admin@lowerslice
