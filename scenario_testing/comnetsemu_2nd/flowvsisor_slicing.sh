...
fvctl -f /etc/flowvisor/flowvisor.passwd add-slice upper tcp:10.244.2.25:10001 admin@upperslice
fvctl -f /etc/flowvisor/flowvisor.passwd add-slice lower tcp:10.244.2.25:10002 admin@lowerslice
