...
fvctl -f /etc/flowvisor/flowvisor.passwd add-slice upper tcp:10.0.2.207:10001 admin@upperslice
fvctl -f /etc/flowvisor/flowvisor.passwd add-slice lower tcp:10.0.2.207:10002 admin@lowerslice
