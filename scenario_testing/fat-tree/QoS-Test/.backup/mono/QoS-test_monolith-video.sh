...
sh tshark -i s4-eth5 -i s1-eth1 -w /root/hasil_test/mono/video/1 -F pcapng -a duration:60
...
sh tshark -i s4-eth5 -i s1-eth1 -w /root/hasil_test/mono/video/2 -F pcapng -a duration:60
...
sh tshark -i s4-eth5 -i s1-eth1 -w /root/hasil_test/mono/video/3 -F pcapng -a duration:60
...
sh tshark -i s4-eth5 -i s1-eth1 -w /root/hasil_test/mono/video/4 -F pcapng -a duration:60
...
sh tshark -i s4-eth5 -i s1-eth1 -w /root/hasil_test/mono/video/5 -F pcapng -a duration:60
...
sh tshark -i s4-eth5 -i s1-eth1 -w /root/hasil_test/mono/video/6 -F pcapng -a duration:60
...
sh tshark -i s4-eth5 -i s1-eth1 -w /root/hasil_test/mono/video/7 -F pcapng -a duration:60
...
sh tshark -i s4-eth5 -i s1-eth1 -w /root/hasil_test/mono/video/8 -F pcapng -a duration:60
...
sh tshark -i s4-eth5 -i s1-eth1 -w /root/hasil_test/mono/video/9 -F pcapng -a duration:60
...
sh tshark -i s4-eth5 -i s1-eth1 -w /root/hasil_test/mono/video/10 -F pcapng -a duration:60
