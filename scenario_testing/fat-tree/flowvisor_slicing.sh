...
fvctl -f /etc/flowvisor/flowvisor.passwd add-slice left tcp:10.0.2.207:10004 admin@leftslice
fvctl -f /etc/flowvisor/flowvisor.passwd add-slice center tcp:10.0.2.207:10005 admin@centerslice
fvctl -f /etc/flowvisor/flowvisor.passwd add-slice right tcp:10.0.2.207:10006 admin@rightslice
...
fvctl -f /etc/flowvisor/flowvisor.passwd add-flowspace dpid12-port2 12 1 in_port=2 center=7
fvctl -f /etc/flowvisor/flowvisor.passwd add-flowspace dpid12-port3 12 1 in_port=3 center=7

fvctl -f /etc/flowvisor/flowvisor.passwd add-flowspace dpid13-port1 13 1 in_port=1 center=7
fvctl -f /etc/flowvisor/flowvisor.passwd add-flowspace dpid13-port2 13 1 in_port=2 center=7
