...
h4 ITGRecv &
h2 ITGSend -T TCP -a 10.0.0.4 -c 100000 -C 1000 -t 150000000 &

h8 ITGRecv &
h6 ITGSend -T TCP -a 10.0.0.8 -c 100000 -C 1000 -t 150000000 &

h12 ITGRecv &
h10 ITGSend -T TCP -a 10.0.0.12 -c 100000 -C 1000 -t 150000000 &
