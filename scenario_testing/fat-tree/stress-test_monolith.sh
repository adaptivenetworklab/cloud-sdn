...
h4 iperf -s -p 5999 -b 5 &
h2 iperf -c h4 -i 1 -t 40 -p 5999 -b 5 &

h8 iperf -s -p 5999 -b 5 &
h6 iperf -c h8 -i 1 -t 40 -p 5999 -b 5 &

h12 iperf -s -p 5999 -b 5 &
h10 iperf -c h12 -i 1 -t 40 -p 5999 -b 5 &
