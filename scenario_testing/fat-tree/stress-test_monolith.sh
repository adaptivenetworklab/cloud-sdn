...
h4 iperf -s -p 5999 -b 12M &
h2 iperf -c h4 -i 1 -t 40 -p 5999 -b 12M &

h8 iperf -s -p 5999 -b 12M &
h6 iperf -c h8 -i 1 -t 40 -p 5999 -b 12M &

h12 iperf -s -p 5999 -b 12M &
h10 iperf -c h12 -i 1 -t 40 -p 5999 -b 12M &
