...
RYU_BASE_URL = "http://" + str(os.environ['UPPER_MIDDLEWARE']) + ":8080"
upper_ryu_app = os.environ['UPPER_RYU_APP']
...
@api.route('/')
def index():
    return 'Upper Slice Rest Server'
...
if __name__ == "__main__":
    api.run(host=upper_ryu_app, port=8090)