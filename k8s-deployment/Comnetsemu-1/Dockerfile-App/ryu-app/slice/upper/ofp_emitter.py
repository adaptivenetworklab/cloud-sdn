...
<<<<<<< HEAD:slicing-script/fat-tree/micro/left-slice/ofp_emitter.py
left_ryu_app = "ws://192.168.1.2:8090"
=======
#upper_ryu_app = "http://192.168.1.2:8090/packetin"
upper_ryu_app = "http://" + str(os.environ['UPPER_RYU_APP']) + ":8090/packetin"
>>>>>>> fbec69869ed959e0936020ebb1b7d55e27bbe4ee:k8s-deployment/Comnetsemu-1/Dockerfile-App/ryu-app/slice/upper/ofp_emitter.py
...
=======
        x = requests.post(upper_ryu_app,json=packet)
>>>>>>> fbec69869ed959e0936020ebb1b7d55e27bbe4ee:k8s-deployment/Comnetsemu-1/Dockerfile-App/ryu-app/slice/upper/ofp_emitter.py
        timestp = datetime.datetime.now()
